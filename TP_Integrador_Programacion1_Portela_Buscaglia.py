...
#
#
# La variable Lista_paises contiene una lista con los 195 países soberanos en el mundo.
...
# que el pais a agregar no se encuentre en la lista, el usuario recibira un aviso y puede optar
...
#
# la variable lista_continentes contine una lista con los datos del modelo de 5 continentes.
# Este modelo es el adoptado oficialmente por la Organización de las Naciones Unidas (ONU),
# al igual que la variable anterior la lista es utilizada para validar el ingreso y de igual
# forma se le permite al usuario realizar un ingreso distinto al que existe dentro de la lista
# pudiendo optar por el modelo de 7 continentes
